  ...
  return (
    <Fragment>
      <main>
        ...
        <CreateBooking isOpen={isOpen} setIsOpen={setIsOpen} closeModal={closeModal} />
        <UpdateBooking isOpen={repairModal} setIsOpen={setRepairModal} closeModal={closeRepair} />
        <ListAttendance
