        ...
        <div className=" flex flex-wrap items-center justify-center font-nunito ">
          <div className="xl:w-2/7 easy-in-out container relative transform rounded-2xl bg-white shadow-lg duration-200 sm:w-full md:w-2/3 lg:w-2/6">
            ...
            <div className="p-5 text-lg">
              <h3 className="text-center text-2xl">Thông tin khách hàng</h3>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span>Họ và tên:</span>{' '}
                  <span className="mx-4 capitalize">{data.customer_name}</span>
                </p>
              </div>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span className="mx-4 ">{data?.customer_phone || 'Chưa cập nhật'}</span>
                </p>
              </div>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span>Email:</span>{' '}
                  <span className="mx-4">{data?.customer_email || 'Chưa cập nhật'}</span>
                </p>
              </div>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span>Địa chỉ:</span>
                  <span className="mx-4 ">{data?.customer_address || 'Chưa cập nhật'}</span>
                </p>
              </div>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span>Giới tính:</span>
                  <span className="mx-4 ">
                    {(data?.status === 0 ? 'Nam' : data?.status === 1 && 'Nữ') || 'Chưa cập nhật'}
                  </span>
                </p>
              </div>
              <div className="flex justify-between border-b px-2 py-2">
                <p className="flex text-gray-700">
                  ...
                  <span className="mx-4 ">{customersSTT[data?.status] || 'Chưa cập nhật'}</span>
                </p>
              </div>
            </div>
          </div>
