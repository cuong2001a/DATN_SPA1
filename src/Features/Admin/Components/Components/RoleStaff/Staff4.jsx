      ...
      <Disclosure>
        <Disclosure.Button className="w-full py-2">
          ...
          >
            ...
            <span className="text-gray-400">Quản lý lịch hẹn</span>
          </NavLink>
        </Disclosure.Button>
        <Disclosure.Button className="w-full py-2">
          <NavLink
            to="/admin/staffs/customer"
            className="flex h-10 w-full cursor-pointer items-center rounded-lg pl-4 hover:bg-gray-700"
          >
            <svg
            ...
            <span className="text-gray-300">Quản lý khách hàng</span>
          </NavLink>
        </Disclosure.Button>
        <Disclosure.Button className="w-full py-2">
          <NavLink
          ...
          >
            ...
            <span className="text-gray-300">Lịch làm việc</span>
          </NavLink>
        </Disclosure.Button>
        <Disclosure.Button className="w-full py-2">
          <NavLink
